...
#define REC_PSR                         MAKE_REC(REC_TYP_PER_LOT, REC_SUB_PSR)
...
#define REC_STR                         MAKE_REC(REC_TYP_PER_EXEC, REC_SUB_STR)
...
typedef dtc_U4*                 dtc_xU4;
typedef dtc_U8*                 dtc_xU8;
