...
void _stdf_read_dtc_Vn2(stdf_file *f, dtc_Vn *pVn, dtc_U2 cnt, dtc_U2 type)
{
        dtc_Vn Vn;
...
#define DO_VN(DTC) \
        ...
        while (cnt-- > 0) {
                switch (type) {
                        case 1: DO_VN(dtc_U1); Vn->type = GDR_U1; break;
                        case 2: DO_VN(dtc_U2); Vn->type = GDR_U2; break;
                        case 4: DO_VN(dtc_U4); Vn->type = GDR_U4; break;
                        case 8: DO_VN(dtc_U8); Vn->type = GDR_U8; break;
