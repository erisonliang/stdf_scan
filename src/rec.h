...
extern rec_psr* stdf_read_rec_psr(stdf_file*) attribute_hidden;
...
extern rec_str* stdf_read_rec_str(stdf_file*) attribute_hidden;
...
extern ssize_t stdf_write_rec_psr(stdf_file*, rec_psr*) attribute_hidden;
...
extern ssize_t stdf_write_rec_str(stdf_file*, rec_str*) attribute_hidden;
